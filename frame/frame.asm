...
;====================================================================
style_frame     db 0C9h, 0CDh, 0BBh, 0BAh, 020h, 0BAh, 0C8h, 0CDh, 0BCh   ; Стиль 1 (классическая одинарная рамка)
                db 0DCh, 0C4h, 0BFh, 0B3h, 020h, 0B3h, 0C0h, 0C4h, 0D9h   ; Стиль 2 (углы и линии с псевдографикой)
                db 0DAh, 0C4h, 0BFh, 0B3h, 020h, 0B3h, 0C0h, 0C4h, 0D9h   ; Стиль 3 (аналогичный стилю 2)
                db 0DEh, 0DFh, 0DFh, 0DFh, 020h, 0DEh, 0DFh, 0DFh, 0DFh   ; Стиль 4 (двойные линии)
                db 03h,  03h,  03h,  03h,  020h, 03h,  03h,  03h,  03h    ; Стиль 5 (простые уголки)
                db 0DBh, 0DBh, 0DBh, 0DBh, 020h, 0DBh, 0DBh, 0DBh, 0DBh   ; Стиль 6 (сплошные блоки)
